...
<body>
<h1>Ajax Helper</h1><p>Hamilton G. Chua (ham\@solutiongrove.com)<br>
September 2007<br>
...
ExtJs 1.1.1 (<a href="http://extjs.com" target="_blank">http://extjs.com</a>)</p><p><strong>What's New :</strong></p><p>0.87d</p><ul>
...
in /ajax/ upon installation of the package.</p><p>Lee Denison's template::head code must be available. This code
will soon be committed to CVS head after consulting the community
and some more testing.</p><p>In the mean time, you can find the files you need to implement
template head from packages/ajaxhlper/www/docs. You should copy the
files into the following locations</p><table width="715" border="1">
<tr>
...
automatically using Lee Denison's template::head code.<br><br><span style="font-weight: bold;">Ajax Procedures :<br><br>
...
for more information about these javascript functions.<br><br>
The Tcl API is used like this<br><pre style="border: 1px dashed rgb(153, 153, 153); padding: 5px; overflow: auto; font-family: Andale Mono,Lucida Console,Monaco,fixed,monospace; color: rgb(0, 0, 0); background-color: rgb(238, 238, 238); font-size: 12px; line-height: 14px; width: 100%;"><code>
...
that is best placed in an  event like "onClick".<br><pre style="border: 1px dashed rgb(153, 153, 153); padding: 5px; overflow: auto; font-family: Andale Mono,Lucida Console,Monaco,fixed,monospace; color: rgb(0, 0, 0); background-color: rgb(238, 238, 238); font-size: 12px; line-height: 14px; width: 100%;"><code>
&lt;a href="#" onClick="\@request;noquote\@"&gt;Send Request&lt;/a&gt;
</code></pre>
Consult the api-doc for more information about other parameters you
can pass on to the ah::ajaxrequest proc.<br><br>
...
request.<br><br>
Here's an example :<br><pre style="border: 1px dashed rgb(153, 153, 153); padding: 5px; overflow: auto; font-family: Andale Mono,Lucida Console,Monaco,fixed,monospace; color: rgb(0, 0, 0); background-color: rgb(238, 238, 238); font-size: 12px; line-height: 14px; width: 100%;"><code>
...
On the adp side, you can just put<br><pre style="border: 1px dashed rgb(153, 153, 153); padding: 5px; overflow: auto; font-family: Andale Mono,Lucida Console,Monaco,fixed,monospace; color: rgb(0, 0, 0); background-color: rgb(238, 238, 238); font-size: 12px; line-height: 14px; width: 100%;"><code>
...
attributes like onClick, onMouseover or onChange.<br><br>
...
content has been updated.<br><br><span style="font-weight: bold;">Cinematic Effects :<br><br>
</span>Use ah::effects to generate javascript that allows you
...
pass to the effect script.<br><br>
...
</code></pre><p>On the adp file you must put the javascript on a click event</p><pre style="border: 1px dashed rgb(153, 153, 153); padding: 5px; overflow: auto; font-family: Andale Mono,Lucida Console,Monaco,fixed,monospace; color: rgb(0, 0, 0); background-color: rgb(238, 238, 238); font-size: 12px; line-height: 14px; width: 100%;"><code>
...
In your tcl file ...</p><pre style="border: 1px dashed rgb(153, 153, 153); padding: 5px; overflow: auto; font-family: Andale Mono,Lucida Console,Monaco,fixed,monospace; color: rgb(0, 0, 0); background-color: rgb(238, 238, 238); font-size: 12px; line-height: 14px; width: 100%;"><code>
   set onmouseover [ah::bubblecallout -text " Contents of My Popup" ]
</code></pre>
The adp file should have something like this ....<br><pre style="border: 1px dashed rgb(153, 153, 153); padding: 5px; overflow: auto; font-family: Andale Mono,Lucida Console,Monaco,fixed,monospace; color: rgb(0, 0, 0); background-color: rgb(238, 238, 238); font-size: 12px; line-height: 14px; width: 100%;"><code>
&lt;a href="#" \@onmouseover;noquote\@ &gt;Link with Popup&lt;/a&gt;<br>
</code></pre><br><span style="font-weight: bold;">Drag and Drop Sortables :<br><br>
</span> Sortables are documented in the scriptaculous wiki
<a href="http://wiki.script.aculo.us/scriptaculous/show/Sortables">http://wiki.script.aculo.us/scriptaculous/show/Sortables.</a><br>

For sortables to work you will need to define a container which
will hold the elements you want to be sortable.<br><br>
Here is what the script looks like<br><pre style="border: 1px dashed rgb(153, 153, 153); padding: 5px; overflow: auto; font-family: Andale Mono,Lucida Console,Monaco,fixed,monospace; color: rgb(0, 0, 0); background-color: rgb(238, 238, 238); font-size: 12px; line-height: 14px; width: 100%;"><code>
